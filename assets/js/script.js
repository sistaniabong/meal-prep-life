...
function displayRecipes(recipes){
    ...
    for(var i=0; i<recipes.length; i++) { //displaying the recipe "card"
        ...
        var recipeEl = $("<div>").attr({"class": "displayContainer"}).css({'border': '3px solid #466786','border-radius': '.3rem', 'background-color':'rgb(213, 254, 222)', 'height': 'auto', 'padding': '10px', "width":"40%", "margin-bottom": "3%"})
